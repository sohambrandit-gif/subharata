              ...
              <table class="datatable table table-stripped">
				...
				?>
                  <tr>
                    ...
                    <td><?php echo $row['is_recurring']; ?></td>
                    <td><?php echo $row['artist_info']; ?></td>
                    ...
                    <td><div class="btn-group">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
                          <?php if($row['valid']==0){ ?>
                          <a class="dropdown-item" href="events_action.php?id=<?php echo $row['sl_id']; ?>&action=Active" >Set Active</a>
                          <?php } else { ?>
                          <a class="dropdown-item" href="events_action.php?id=<?php echo $row['sl_id']; ?>&action=Regular" >Set Block</a>
                          <?php } ?>
                          <?php if($row['is_recurring']==0){ ?>
                          <a class="dropdown-item" href="events_action.php?id=<?php echo $row['sl_id']; ?>&action=Multiple" >Set Multiple</a>
                          <?php } else { ?>
                          <a class="dropdown-item" href="events_action.php?id=<?php echo $row['sl_id']; ?>&action=Single" >Set Single</a>
                          <?php } ?>
						   
                           
                          <a class="dropdown-item" href="events.php?sl_id=<?php echo $row['sl_id']; ?>&#update">Edit</a>
                          <a class="dropdown-item" href="event_location.php?event_id=<?php echo $row['sl_id']; ?>#update">Add Location</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="events_del.php?id=<?php echo $row['sl_id']; ?>" onclick="return confirm('Do you want to delete the item?')">Delete</a> </div>
                      </div></td>
                  </tr>
                  <?php } ?>
                </tbody>
			 ...
			 <div class="row">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="position" required value="<?php echo $row['position']; ?>">
                  </div>
                </div>
			 </div>
