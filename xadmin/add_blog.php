            ...
            <form action="blog_chk.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control" name="boldtext" required
                      value="<?php echo $row['boldtext']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea rows="5" cols="5" class="form-control" placeholder="Enter text here"
                      name="seo_description"><?php echo $row['seo_description']; ?></textarea>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Seo Keywords</label>
                    <textarea rows="5" cols="5" class="form-control" placeholder="(,) seperated"
                      name="seo_tags"><?php echo $row['seo_tags']; ?></textarea>
                  </div>
                </div>
              </div>
