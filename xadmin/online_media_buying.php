...
<div class="page-wrapper">
  <div class="content container-fluid">
    ...
    <div class="page-header">
      <div class="row">
        <div class="col-sm-12">
          <h3 class="page-title">Online Media Buying</h3>
        </div>
      </div>
    </div>
    <!-- /Page Header -->
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=35&page=online_media_buying" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=35";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
              <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=36&page=online_media_buying" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=36";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=37&page=online_media_buying" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=37";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
			 <div class="form-group">
