    ...
    <div class="content container-fluid">
                                                    ...
                                                    <div class="dropdown-menu" x-placement="bottom-start"
                                                        ...
                                                        <?php if ($row['valid'] == 0) { ?>
                                                            <a class="dropdown-item"
                                                                href="event_location_action.php?id=<?php echo $row['sl_id']; ?>&event_id=<?php echo $_GET['event_id']; ?>&action=Active">Set
                                                                Active</a>
                                                        <?php } else { ?>
                                                            <a class="dropdown-item"
                                                                href="event_location_action.php?id=<?php echo $row['sl_id']; ?>&event_id=<?php echo $_GET['event_id']; ?>&action=Regular">Set
                                                                Block</a>
                                                        <?php } ?>


                                                        <a class="dropdown-item"
                                                            href="event_location.php?sl_id=<?php echo $row['sl_id']; ?>&event_id=<?php echo $_GET['event_id']; ?>&#update">Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item"
                                                            href="event_location_del.php?id=<?php echo $row['sl_id']; ?>&event_id=<?php echo $_GET['event_id']; ?>"
        ...
        <div class="row" id="update">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add/Edit Event Location</h4>
                    </div>
                    <div class="card-body">
                        <form action="event_location_chk.php?id=<?php echo $_GET['sl_id']; ?>" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter location here"
                                            name="location" value="<?php echo $row['location']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Address iframe (width="600" height="300")</label>
                                        <textarea class="form-control" name="addressiframe"
                                            placeholder="Paste iframe code here"
                                            rows="5"><?php echo htmlspecialchars($row['addressiframe']); ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>pin</label>
                                        <input class="form-control" type="number" placeholder="Enter pin here"
                                            name="pin" value="<?php echo $row['pin']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>contact_no</label>
                                        <input class="form-control" type="number" placeholder="Enter contact_no here"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="booked"
                                            value="<?php echo $row['booked']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>lastbooking_date</label>
                                        <input type="date" class="form-control" name="lastbooking_date"
                                            value="<?php echo $row['lastbooking_date']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type1">
                                            <option value="VIP" <?php echo ($row['type1'] == 'VIP') ? 'selected' : ''; ?>>
                                                VIP</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type2">
                                            <option value="VIP" <?php echo ($row['type2'] == 'VIP') ? 'selected' : ''; ?>>
                                                VIP</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type3">
                                            <option value="VIP" <?php echo ($row['type3'] == 'VIP') ? 'selected' : ''; ?>>
                                                VIP</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type4">
                                            <option value="VIP" <?php echo ($row['type4'] == 'VIP') ? 'selected' : ''; ?>>
                                                VIP</option>
