...
<body>
  ...
  <div class="main-wrapper">
    ...
    <div class="header">
      <!-- Logo -->
      <div class="header-left"> <a href="index.php" class="logo" style="color: #fff;font-size: 21px;">
          <?php echo $company; ?></a> <a href="index.php" class="logo logo-small"
          style="color: #fff;font-size: 21px;">BrandIT Consultancy</a> </div>
      <!-- /Logo -->
      ...
      <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow"> <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
            <span class="user-img"><img class="rounded-circle" src="favicon/favicon-96x96.png?" width="31"
                alt="BrandIt Consultancy"></span> </a>
          <div class="dropdown-menu">
            <div class="user-header">
              <div class="avatar avatar-sm"> <img src="favicon/favicon-96x96.png?" alt="User Image"
        ...
        <div id="sidebar-menu" class="sidebar-menu">
          <ul>
            ...
            <li class="submenu <?php if ($page == 'order') { ?>active<?php } ?>"> <a href="javscript:void(0)"><i
                  class="fe fe-document"></i> <span> Orders</span> <span class="menu-arrow"></span></a>
              <ul style="display: none;">
                <li> <a href="order.php?type="><i class="fe fe-document"></i> <span>All</span></a> </li>
                <li> <a href="order.php?status=Processing"><i class="fe fe-document"></i> <span>Processing</span></a>
                </li>
                <li> <a href="order.php?status=Cancelled"><i class="fe fe-document"></i> <span>Cancelled</span></a>
                </li>
                <li> <a href="order.php?status=Delivered"><i class="fe fe-document"></i> <span>Delivered</span></a>
                </li>
                <li> <a href="order.php?payment_method=Online"><i class="fe fe-document"></i> <span>Prepaid</span></a>
                </li>
                <li> <a href="order.php?payment_method=Cash on delivery"><i class="fe fe-document"></i>
                    <span>COD</span></a> </li>

                <li> <a href="order.php?payment=Refunded"><i class="fe fe-document"></i> <span>Refunded</span></a> </li>
              </ul>
            </li>
            <li <?php if ($page == 'manufacture') { ?>class="active" <?php } ?>> <a href="manufacture.php"><i
                  class="fe fe-document"></i> <span>Manufacture</span></a> </li>



            <li <?php if ($page == 'category') { ?>class="active" <?php } ?>> <a href="category.php"><i
                  class="fe fe-document"></i> <span>Category</span></a> </li>


            <li class="submenu <?php if ($page == 'product') { ?>active<?php } ?>"> <a href="javscript:void(0)"><i
                  class="fe fe-document"></i> <span> Products</span> <span class="menu-arrow"></span></a>
              <ul style="display: none;">
                ...
                while ($row = mysqli_fetch_array($res)) {
                  ?>
                  <li> <a href="product.php?cat=<?php echo $row['sl_id']; ?>"><i class="fe fe-document"></i>
                      <span><?php echo $row['name']; ?></span></a> </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <li class="submenu <?php if ($page == 'blog' || $page == 'add_blog') { ?>active<?php } ?>"> <a
                href="javscript:void(0)"><i class="fe fe-layout"></i> <span> Blog</span> <span
            ...
            <li <?php if ($page == 'contact') { ?>class="active" <?php } ?>> <a href="contact.php"><i
                  class="fe fe-document"></i> <span>Contact</span></a> </li>
            <li <?php if ($page == 'faq') { ?>class="active" <?php } ?>> <a href="faq.php"><i class="fe fe-document"></i>
                <span>Faq</span></a> </li>
            <li <?php if ($page == 'testimonial') { ?>class="active" <?php } ?>> <a href="testimonial.php"><i
                  class="fe fe-document"></i> <span>Testimonial</span></a> </li>

            <li class="submenu <?php if ($page == 'service') { ?>active<?php } ?>"> <a href="javscript:void(0)"><i
                  class="fe fe-document"></i> <span> Static Pages</span> <span class="menu-arrow"></span></a>
              <ul style="display: none;">
                <?php $sql12 = "SELECT * FROM services";
                $res = mysqli_query($conn, $sql12);
                while ($row = mysqli_fetch_array($res)) {
                  ?>
                  <li> <a href="service.php?id=<?php echo $row['sl_id']; ?>"><i class="fe fe-document"></i>
                      <span><?php echo $row['title1']; ?></span></a> </li>
                <?php } ?>
              </ul>
            </li>
            ...
            <?php ?>
            <li
              class="submenu <?php if ($page == 'lead' && $_GET['type'] == 'Normal' || $page == 'lead' && $_GET['type'] == 'Google' || $page == 'lead' && $_GET['type'] == 'Phone') { ?>active<?php } ?>">
              <a href="javscript:void(0)"><i class="fe fe-layout"></i> <span> Users</span> <span
                  class="menu-arrow"></span></a>
              <ul style="display: none;">
