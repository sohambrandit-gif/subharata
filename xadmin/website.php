    ...
    <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="banner_chk.php?id=1&page=about" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM banner where sl_id=10";
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=10&page=website" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=10";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
              <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=11&page=website" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=11";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=12&page=website" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=12";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
			 <div class="form-group">
