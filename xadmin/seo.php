    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=17&page=seo" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=17";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
              <div class="form-group">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=18&page=seo" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=18";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <form action="about_chk.php?id=19&page=seo" method="post" enctype="multipart/form-data">
              <?php $sql12 = "SELECT * FROM about where sl_id=19";
			$res=mysqli_query($conn,$sql12);
			$row=mysqli_fetch_array($res);
			?>
			 <div class="form-group">
