        ...
        <section class="bd-authentication-cover-main ">
            <div class="row h100vh mx-0">
                <div class="col-xxl-6 col-xl-5 col-lg-12 d-xl-block d-none px-0">
                    <div class="bd-authentication-cover overflow-hidden" data-background="assets/images/contact/sign-up-bg.webp">
                        <div class="bd-authentication-cover-content d-flex-center d-none">
                            <div class="bd-section-title-wrapper">
                                <h2 class="bd-section-title mb-20">Join Us Today!</h2>
                                <p class="bd-section-paragraph">Create your account and step into a world filled with
                    ...
                    <div class="row justify-content-center align-items-center h100p">
                        <div class="col-xxl-7 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                            <div class="bd-authentication-form-wrapper">
                                ...
                                <h3 class="title mb-10">Sign Up</h3>
                                <p class="subtitle">Join us by creating a free account</p>
                                <form action="reg_chk.php" method="post" class="form-login form-has-password">
                                    <div class="form-input-box mb-20">
                                        <div class="form-input-title">
                                            <label for="fullName">First Name <span>*</span></label>
                                        </div>
                                        <div class="form-input">
                                            <input name="fname" id="fullName" type="text" placeholder="Full Name">
                                        </div>
                                    </div>
                                    <div class="form-input-box mb-20">
                                        <div class="form-input-title">
                                            <label for="fullName">Last Name <span>*</span></label>
                                        </div>
                                        <div class="form-input">
                                            <input name="lname" id="fullName" type="text" placeholder="Full Name">
                                        </div>
                                    </div>
                                    <div class="form-input-box mb-20">
                                        <div class="form-input-title">
                                        ...
                                        <div class="form-input">
                                            <input name="phone" id="phoneNumber" type="number" placeholder="Phone Number">
                                        </div>
                                    </div>
                                    <div class="form-input-box mb-20">
                                        <div class="form-input-title">
                                    ...
                                    <div class="bd-sign-btn">
                                        <button type ="submit" class="bd-btn btn-primary w-100">Create Account</button>
                                    </div>
                                </form>
                                <div class="bd-divider-wrapper">
                                    <div class="bd-divider-line left-line"></div>
                                    <span class="bd-divider-title">OR SignUp With</span>
                                ...
                                <div class="bd-sign-up-label underline-two text-center">
                                    Don't have an account?<a href="sign-in.html" class="sign-link"> Sign In</a>
                                </div>
                            </div>
                        </div>
                    </div>
