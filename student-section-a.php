...
?>
<?php 
    $sql12 = "SELECT class_a1_audio,class_a2_audio,class_a_pdf FROM classes";
...
<script>
    ...
    pdfjsLib.getDocument('<?php echo 'uploads/classes/class_pdf/' . $row['class_a_pdf']; ?>').promise.then(function(pdf) {
        pdfDoc = pdf;
