...
?>
<?php
$sql12 = "SELECT class_a1_audio,class_a2_audio,class_a3_audio,class_a4_audio,class_a_pdf FROM student_section";
$res = mysqli_query($conn, $sql12);
$row = mysqli_fetch_array($res);
?>
<div class="container py-5">
    <h1 class="text-center mb-5">Class A</h1>
    ...
    <!-- Third Audio Section -->
    <div class="audio-container">
        <h3 class="audio-title">Audio Sample 3</h3>
        <div class="row">
            <div class="col-md-8">
                <audio id="audio3" controls class="w-100 no-context-menu">
                    <source src="<?php echo 'uploads/student_section/class_audio/' . $row['class_a3_audio']; ?>"
                        type="audio/mpeg">
                    Your browser does not support the audio element.
                </audio>
            </div>
            <div class="col-md-4 d-flex align-items-center">
                <p class="mb-0 text-muted">Listen to our third audio sample</p>
            </div>
        </div>
    </div>

    <div class="audio-container">
        <h3 class="audio-title">Audio Sample 4</h3>
        <div class="row">
            <div class="col-md-8">
                <audio id="audio4" controls class="w-100 no-context-menu">
                    <source src="<?php echo 'uploads/student_section/class_audio/' . $row['class_a4_audio']; ?>"
                        type="audio/mpeg">
                    Your browser does not support the audio element.
                </audio>
            </div>
            <div class="col-md-4 d-flex align-items-center">
                <p class="mb-0 text-muted">Listen to our fourth audio sample</p>
            </div>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        pdfjsLib.getDocument('<?php echo 'uploads/student_section/class_pdf/' . $row['class_a_pdf']; ?>').promise.then(function (pdf) {
            pdfDoc = pdf;
