...
?>
<?php 
    $sql12 = "SELECT class_b1_audio,class_b2_audio,class_b_pdf FROM classes";
...
<script>
    ...
    pdfjsLib.getDocument('<?php echo 'uploads/classes/class_pdf/' . $row['class_b_pdf']; ?>').promise.then(function(pdf) {
        pdfDoc = pdf;
