...
?>
<?php 
    $sql12 = "SELECT class_c1_audio,class_c2_audio,class_c_pdf FROM classes";
...
<script>
    ...
    pdfjsLib.getDocument('<?php echo 'uploads/classes/class_pdf/' . $row['class_c_pdf']; ?>').promise.then(function(pdf) {
        pdfDoc = pdf;
