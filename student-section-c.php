...
?>
<?php 
    $sql12 = "SELECT class_c1_audio,class_c2_audio,class_c_pdf FROM student_section";
    $res = mysqli_query($conn, $sql12);
    $row = mysqli_fetch_array($res);
?>
<div class="container py-5">
    <h1 class="text-center mb-5">Class C</h1>
        ...
        <div class="row">
            <div class="col-md-8">
                <audio id="audio1" controls class="w-100 no-context-menu">
                    <source src="<?php echo 'uploads/student_section/class_audio/' . $row['class_c1_audio']; ?>" type="audio/mpeg">
        ...
        <div class="row">
            <div class="col-md-8">
                <audio id="audio2" controls class="w-100 no-context-menu">
                    <source src="<?php echo 'uploads/student_section/class_audio/' . $row['class_c2_audio']; ?>" type="audio/mpeg">
                    Your browser does not support the audio element.
                </audio>
            </div>
            <div class="col-md-4 d-flex align-items-center">
...
<script>
    ...
    pdfjsLib.getDocument('<?php echo 'uploads/student_section/class_pdf/' . $row['class_c_pdf']; ?>').promise.then(function(pdf) {
        pdfDoc = pdf;
